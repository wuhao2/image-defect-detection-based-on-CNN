...
__author__ = 'wuhao'
__date__ = '2017/8/4 15:22'

'''
3 Retraining (Finetuning) Example with vgg.tflearn. Using weights from VGG model to retrain
4 network for a new task (your own dataset).All weights are restored except
5 last layer (softmax) that will be retrained to match the new task (finetuning).
6
'''
import tflearn
...
img_prep.add_featurewise_zero_center(mean=[123.68, 116.779, 103.939], er_channel=True)
